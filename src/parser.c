...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(aux_sym_commodity_token2_character_set_1, 18, lookahead)) ADVANCE(554);
      if (set_contains(aux_sym_tag_directive_token1_character_set_2, 431, lookahead)) ADVANCE(553);
      END_STATE();
    case 1:
      ADVANCE_MAP(
        '\t', 566,
    ...
    case 2:
      ...
      if (('-' <= lookahead && lookahead <= '/')) ADVANCE(407);
    ...
    case 4:
      ...
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(410);
      if (set_contains(aux_sym_commodity_token2_character_set_1, 18, lookahead)) ADVANCE(554);
      if (set_contains(aux_sym_tag_directive_token1_character_set_1, 430, lookahead)) ADVANCE(553);
      END_STATE();
    case 5:
      if (lookahead == '\t') ADVANCE(566);
      if (lookahead == ' ') ADVANCE(558);
